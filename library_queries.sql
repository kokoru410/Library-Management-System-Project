...
-- Now We Will Perform Some CRUD OPERATIONS On The Database
...
INSERT INTO members(member_id, member_name, member_address, reg_date) 
VALUES
('C121', 'sam altman', '145 Main St', '2024-06-01'),
('C122', 'john cena', '133 Main St', '2024-05-01');
...
-- Task 13: Add a column in the return status table called Book Quality 
...
/*
Task 6: Stored Procedure Objective: 
...
-- the above process is manually done taking much time instead use store procedures in MySql below
...
BEGIN
    ...
    -- Step 4: MySQL way to show message (replacement for RAISE NOTICE)
